...
const PWDTransferFrom1 = () => {
  const [menu, setMenu] = useRecoilState(proWashNavState);
  return (
    <div className="PWD-Transfer-From-1 text-white p-2 h-full flex flex-col justify-between">
      <div className="PWD-Transfer-From-1-Header flex items-start">
        <div className="flex p-[.65rem] rounded-[10px] flex-[0.15] relative">
          <div className="w-4/5">
            ...
            <img
              ...
              alt=""
              className="absolute h-[25%] top-[38%] left-[34%] rotate-180"
            />
          </div>
        </div>
        <div className="flex justify-center flex-[0.85]">
          <div className="flex flex-col text-[2rem] leading-9">
            ...
            <p className="w-4/5">
              Transfer liquid from reservoir 1 to reservoir 2.
            </p>
          </div>
        </div>
      </div>
      <div className="PWD-Transfer-From-1-Body flex items-end h-full py-6 relative">
        <img src="/PWD/SVG/TransferWarning.svg" alt="" />
        <div className="absolute left-1/4 bottom-[22%] leading-9 w-[65%]">
      ...
      <div className="PWD-Transfer-From-1-Buttons flex w-full gap-6">
        <h3
...
export default PWDTransferFrom1;
